...
public class TC_02_RADailyReportUIValidationMOSMS implements ApplicationConstants {
	
	private static final Logger LOGGER = Logger.getLogger(TC_02_RADailyReportUIValidationMOSMS.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest(
				"Execution triggered for - TC_02_RADailyReportUIValidationMOSMS -with TestdataId: " + uniqueDataId);
		...
		cu.getScreenShot("Validation Of RA Daily Report Screen");
