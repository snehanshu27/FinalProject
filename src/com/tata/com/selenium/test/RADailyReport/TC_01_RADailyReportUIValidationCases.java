...
public class TC_01_RADailyReportUIValidationCases implements ApplicationConstants {
	
	private static final Logger LOGGER = Logger.getLogger(TC_01_RADailyReportUIValidationCases.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest(
				"Execution triggered for - TC_01_RADailyReportUIValidationCases -with TestdataId: " + uniqueDataId);
