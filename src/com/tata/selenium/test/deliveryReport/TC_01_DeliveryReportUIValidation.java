package com.tata.selenium.test.deliveryReport;
...
public class TC_01_DeliveryReportUIValidation implements ApplicationConstants{
	
	private static final Logger LOGGER = Logger.getLogger(TC_01_DeliveryReportUIValidation.class.getName());
	String properties = "./data/DeliveryReport.properties";
    ...
    public void Do(String uniqueDataId, String testCaseId){
    	test = extent.startTest("Execution triggered for -"+TC_01_DeliveryReportUIValidation.class.getName()+" - "+uniqueDataId);
    	String sheetName = "DeliveryReport_Screen";
    	try {
		...
		cu.checkEditableBox("DeliveryReport_MessageID_TextBox");
		cu.checkElementPresence("DeliveryReport_Display_Button");
		cu.checkElementPresence("DeliveryReport_Cancel_Button");
		cu.checkElementPresence("DeliveryReport_Export_Link");
		
		cu.getScreenShot("Validation Of UI elements in Delivery Report Screen");
		test = cu.getExTest();
	  ...
	  public void beforeMethod(String testCaseId) throws Exception {
		  ...
		  extent = ExtReport.instance("Delivery_Report");
	  }	
