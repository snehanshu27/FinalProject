...
public class TC_01_ProductPriceUIVAlidation implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_01_ProductPriceUIVAlidation.class.getName());
	...
	public void DO (String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest("Execution triggered for - TC_01_ProductPriceUIVAlidation - "+uniqueDataId);
		...
		cu.checkEditableDropDown("Service_NameLst",dataMap.get("Service_NameLst"));
		cu.checkEditableDropDown("Product_NameLst",dataMap.get("Product_NameLst"));
		cu.checkEditableDropDown("PriceCardLst",dataMap.get("PriceCardLst"));
		cu.checkNonEditableBox("CurrencyTxt");
