...
public class TC_02_DeliveryStatisticsDisplayData implements ApplicationConstants {
	...
	//Select filters
		...
		if(cu.elementDisplayed("tableFirstRow", 3))
		...
		{
			test.log(LogStatus.FAIL, "EXPECTED: Data should be displayed after clicking on Display button with selected parameters",
	...
	@AfterMethod
	  public void afterMethodFailed(ITestResult result) {		  
		  ...
		  if(ITestResult.FAILURE ==result.getStatus()
			  ...
			  test.log(LogStatus.FAIL, "Error Ocuured in execution", "Error Ocuured in while executing the test case.<br/> Exception trace:<br/><br/> "
