...
public class TC_01_MNPUIValidation implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_01_MNPUIValidation.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) {
		...
		test = extent.startTest(
				...
				cu.checkNonEditableDropDown("Product_Provisioning_MNPFlag");
				...
				cu.getScreenShot("Validation Of UI parameters for MNP Screen");
