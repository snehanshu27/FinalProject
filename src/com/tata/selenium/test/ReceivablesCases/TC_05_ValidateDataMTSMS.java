...
public class TC_05_ValidateDataMTSMS implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_05_ValidateDataMTSMS.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId)  {
		...
		test = extent
				.startTest("Execution triggered for - TC_05_ValidateDataMTSMS -with TestdataId: " + uniqueDataId);
		...
		String destination = cu.getText("dynamicDestination", "$CustomerAcc$", dataMap.get("CustAccName"));
		String mcc = cu.getText("dynamicMCC", "$CustomerAcc$", dataMap.get("CustAccName"));
		String mnc = cu.getText("dynamicMNC", "$CustomerAcc$", dataMap.get("CustAccName"));
