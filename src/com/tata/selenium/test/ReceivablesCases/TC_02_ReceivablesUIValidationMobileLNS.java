...
public class TC_02_ReceivablesUIValidationMobileLNS implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_02_ReceivablesUIValidationMobileLNS.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest(
				"Execution triggered for - TC_02_ReceivablesUIValidationMobileLNS -with TestdataId: " + uniqueDataId);
