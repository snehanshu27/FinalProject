...
public class TC_003_RetrySchemeListVerification implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_003_RetrySchemeListVerification.class.getName());
	...
	//	if(checkDataBase().equalsIgnoreCase("pass"))
		//{
		test = extent.startTest("Execution triggered for - TC_003_RetrySchemeListVerification -with TestdataId: "+uniqueDataId);
		LOGGER.info("Execution triggered for - TC_003_RetrySchemeListVerification -with TestdataId: " + uniqueDataId);
		...
		hu.checkElementPresence("retrySchemeList_Error");
		hu.checkElementPresence("retrySchemeList_Description");
		hu.checkElementPresence("retrySchemeList_Action");
