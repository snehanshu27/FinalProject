...
public class TC_004_AddRowToRetrySchemeList implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_004_AddRowToRetrySchemeList.class.getName());
	...
	//	if(checkDataBase().equalsIgnoreCase("pass"))
		//{
		test = extent.startTest("Execution triggered for - TC_004_AddRowToRetrySchemeList -with TestdataId: "+uniqueDataId);
		LOGGER.info("Execution triggered for - TC_004_AddRowToRetrySchemeList -with TestdataId: " + uniqueDataId);
