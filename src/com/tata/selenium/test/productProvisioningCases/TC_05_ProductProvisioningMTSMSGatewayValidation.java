...
public class TC_05_ProductProvisioningMTSMSGatewayValidation implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_05_ProductProvisioningMTSMSGatewayValidation.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) {
		...
		test = extent
				.startTest("Execution triggered for - TC_05_ProductProvisioningMTSMSGatewayValidation -with TestdataId: "
						+ uniqueDataId);
		...
		cu.existsElement("DefaultGateway_CheckedRadioBtn");
		cu.existsElement("DefaultRoaming_CheckedRadioBtn");
