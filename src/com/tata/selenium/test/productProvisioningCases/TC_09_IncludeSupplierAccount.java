...
public class TC_09_IncludeSupplierAccount implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_09_IncludeSupplierAccount.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId){
		...
		test = extent.startTest(
				"Execution triggered for - TC_09_IncludeSupplierAccount -with TestdataId: " + uniqueDataId);
		...
		SupplierAccClick(dataMap.get("SupplierAccName"));
	...
	private void SupplierAccClick(String firstLink) {
		String linkName = "//*[@id='myTable']/tbody/tr/td[text()='" + firstLink + "']/../td/input[@type='checkbox']";
