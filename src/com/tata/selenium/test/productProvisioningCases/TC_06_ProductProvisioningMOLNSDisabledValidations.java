...
public class TC_06_ProductProvisioningMOLNSDisabledValidations implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_06_ProductProvisioningMOLNSDisabledValidations.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId){
		...
		test = extent
				.startTest("Execution triggered for - TC_06_ProductProvisioningMOLNSDisabledValidations -with TestdataId: "
						+ uniqueDataId);
		...
		cu.checkNonEditableDropDown("Product_Provisioning_PriorityLst");
		cu.checkReadonlyProperty("Product_Provisioning_PValueTxt");
		cu.ElementNotExists("DefaultGateway_CheckedRadioBtn");
		cu.ElementNotExists("DefaultRoaming_CheckedRadioBtn");
