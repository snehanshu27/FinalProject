...
public class TC_01_RoutingDetailsUIValidation implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_01_RoutingDetailsUIValidation.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest(
				"Execution triggered for - TC_01_RoutingDetailsUIValidation -with TestdataId: " + uniqueDataId);
		...
		// Validating all editable drop down and textboxes
		...
		cu.checkEditableDropDown("Product_Routing_Details_ReportType_Dropdown", dataMap.get("Report_Type"));


		// Validating all buttons
		cu.checkElementPresence("Product_Routing_Details_Display_Button");
		cu.checkElementPresence("Product_Routing_Details_Clear_Button");
