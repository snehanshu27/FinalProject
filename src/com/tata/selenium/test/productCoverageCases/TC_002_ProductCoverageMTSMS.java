...
public class TC_002_ProductCoverageMTSMS implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_002_ProductCoverageMTSMS.class.getName());
	...
	public void DO (String uniqueDataId, String testCaseId) {
		...
		test = extent.startTest("Execution triggered for - TC_002_ProductCoverageMTSMS -with TestdataId: "+uniqueDataId);
		...
		//For validating ValidateFirstAccNameAutoPopulated
		...
		//Selecting required values from drop down based on input
		////For validating ValidateHistory
...
System.out.println("Before coverage1");
		...
		System.out.println("Before Validate2");
