...
public class TC_06_CSVExportValidation implements ApplicationConstants {
	
	private static final Logger LOGGER = Logger.getLogger(TC_06_CSVExportValidation.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) {
		...
		test = extent.startTest(
				"Execution triggered for - "+TC_06_CSVExportValidation.class.getName()+" -with TestdataId: " + uniqueDataId);
			...
			if(subRuleRowsSize>0)
			{
				...
				{					
					 ...
					 Map<String, String> curMap= new LinkedHashMap<>();
						...
						curMap.put("Status", status);
						curMap.put("Country", country);
						curMap.put("Destination", destination);
						curMap.put("Supplier", supplier);
						curMap.put("Supplier Account", supplierAcc);
						curMap.put("Customer", customer);
						curMap.put("Customer Account", customerAcc);
						curMap.put("TON Blacklist Condition", tON_BL_Cond);
						...
						curMap.put("Control", subRuleStatus);
						
						curMap.put("Comments", comment);
						curMap.put("User", userModified);
						curMap.put("Date", lastModifiedDate);
