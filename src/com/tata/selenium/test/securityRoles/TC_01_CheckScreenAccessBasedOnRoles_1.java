...
public class TC_01_CheckScreenAccessBasedOnRoles_1 implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_01_CheckScreenAccessBasedOnRoles_1.class.getName());
