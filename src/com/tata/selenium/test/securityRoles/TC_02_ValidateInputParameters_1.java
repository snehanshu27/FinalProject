...
public class TC_02_ValidateInputParameters_1 implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_02_ValidateInputParameters_1.class.getName());
