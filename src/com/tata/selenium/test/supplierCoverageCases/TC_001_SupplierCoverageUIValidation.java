...
public class TC_001_SupplierCoverageUIValidation implements ApplicationConstants {
	...
	public void DO (String uniqueDataId, String testCaseId) {
		...
		hu.checkEditableDropDown("supplierAccNameLst", dataMap.get("Supplier_Account_Name"));
		hu.checkEditableDropDown("supplierCoverageHistoryLst", dataMap.get("Coverage_History"));
		...
		if("MT SMS".equalsIgnoreCase(dataMap.get("Service")))
		{
			...
			hu.checkElementPresence("uploadBtn");
		}
