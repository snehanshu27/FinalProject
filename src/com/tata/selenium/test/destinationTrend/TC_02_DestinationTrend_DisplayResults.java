...
//import com.tata.selenium.test.performanceTrend.TC_02_DisplayingResults;
...
public class TC_02_DestinationTrend_DisplayResults implements ApplicationConstants {
	
	private static final Logger LOGGER = Logger.getLogger(TC_02_DestinationTrend_DisplayResults.class.getName());
	...
	public void DO (String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest("Execution triggered for - TC_02_DestinationTrend_DisplayResults - "+uniqueDataId);
		...
		cu.waitForPageLoad("Destination Trend");
		cu.default_content();
		...
		cu.waitForPageLoad("");
		cu.getScreenShot("Successfully clicked display btn after selecting the appropriate Service");
		
		if(cu.existsElement("application_PopUpTitle"))
		{
		popUpName = cu.getText("application_PopUpMessage");
		cu.clickElement("application_PopUpOkBtn");
		cu.getScreenShot("Destination Trend Screen after accepting pop up");
		}else{
