...
//import com.tata.selenium.test.performanceTrend.TC_01_PerformanceTrendUIVAlidation;
...
public class TC_01_DestinationTrendUIValidation implements ApplicationConstants {

	private static final Logger LOGGER = Logger.getLogger(TC_01_DestinationTrendUIValidation.class.getName());
	...
	public void DO (String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest("Execution triggered for - TC_01_DestinationTrendUIValidation - "+uniqueDataId);
		...
		cu.getScreenShot("Validation Of UI elements in Destination Trend");
		test = cu.getExTest();
