package com.tata.selenium.test.destinationTrend;
...
import com.tata.selenium.test.performanceTrend.TC_03_ToDateSmallerThanFromValidation;
...
public class TC_03_DestinationTrendDateValidation implements ApplicationConstants {

	private static final Logger LOGGER = Logger.getLogger(TC_03_DestinationTrendDateValidation.class.getName());
	String properties =  "./data/DestinationTrend.properties";
	...
	public void DO (String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest("Execution triggered for - TC_03_DestinationTrendDateValidation - "+uniqueDataId);
		String sheetName="Destination_Trend";
		...
		cu.waitForPageLoad("");
		cu.checkMessage("application_PopUpOkBtn", "Validating error pop up for ot date lesser than from date.", "Error: To Date should be greater than or equal to From");
		
		cu.getScreenShot("UI elements in Destination Trend");
		test = cu.getExTest();
	  ...
	  public void beforeMethod(String testCaseId) throws Exception {
		  ...
		  extent = ExtReport.instance("DestinationTrend");
	  }	
