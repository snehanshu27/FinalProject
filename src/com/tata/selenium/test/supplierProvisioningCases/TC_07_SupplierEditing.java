...
public class TC_07_SupplierEditing  implements ApplicationConstants {
	
	private static final Logger LOGGER = Logger.getLogger(TC_07_SupplierEditing.class.getName());
...
//		cu.SelectDropDownByVisibleText("Supplier_Account_Name" , dataMap.get("Supplier_Account_Name"));
		...
		if(cu.isDisabledBtn("supplier_SubmitBtn")){
...
//		Thread.sleep(5000);
		...
		cu.checkMessage("application_PopUpTitle", "Validating Pop Up after Clicking Submit Btn", "Warning: This action will also submit the details for other instances and create an order. Do you want to Continue?");
