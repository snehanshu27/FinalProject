...
public class TC_09_NewSupplierAccountCreation implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_09_NewSupplierAccountCreation.class.getName());
...
/*
		...
		{*/
		//Checking if any error occurred in creating new Supplier
		...
		*/
		...
		/*
		if(cu.currentSelectedVal("Supplier_Account_Name").equalsIgnoreCase(dataMap.get("Supplier_Account_Name"))&& ("ALL").equalsIgnoreCase(cu.currentSelectedVal("Instance"))){
