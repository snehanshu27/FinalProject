...
public class TC_03_SupplierCreationFormValidation implements ApplicationConstants {
	
	private static final Logger LOGGER = Logger.getLogger(TC_03_SupplierCreationFormValidation.class.getName());
	...
	public void DO (String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest("Execution triggered for  - TC_03_SupplierCreationFormValidation  -with TestdataId: "+uniqueDataId);
		...
		cu.checkEditableDropDown("nws_supplier_Security", dataMap.get("Security"));
	
		cu.checkEditableBox("nws_supplier_Acc_name" , dataMap.get("Supplier_Account_Name"));
		cu.checkEditableBox("nws_supplier_Acc_name" , dataMap.get("Supplier_Account_Name"));
		
		//Entering data in text field
		cu.checkElementPresence("nws_CreateBtn");
		cu.checkElementPresence("nws_CancelBtn");
		cu.getScreenShot("Validation Of Supplier Creation Screen");
