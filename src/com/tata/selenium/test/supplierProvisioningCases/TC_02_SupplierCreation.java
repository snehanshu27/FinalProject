...
public class TC_02_SupplierCreation implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_02_SupplierCreation.class.getName());
