...
public class TC_01_TopNDestinationUIValidation implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_01_TopNDestinationUIValidation.class.getName());
	...
	public void DO (String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest("Execution triggered for - "+TC_01_TopNDestinationUIValidation.class.getName()+" - "+uniqueDataId);
		...
		cu.checkEditableDropDown("TopNDestination_Service_DropDown" , dataMap.get("Service"));
		cu.checkElementPresence("TopNDestination_CustomerListButton");
		cu.checkElementPresence("TopNDestination_SupplierListButton");
		cu.checkEditableBox("TopNDestination_N_Text", dataMap.get("N"));
		cu.checkEditableDropDown("TopNDestination_Granularity_DropDown", dataMap.get("Granularity"));
		cu.checkNonClickableButton("TopNDestination_CountryListButton");
		cu.checkElementPresence("TopNDestination_ProductListButton");
		cu.checkElementPresence("TopNDestination_From_Date_SelectfromCalendar");
		cu.checkEditableDropDown("TopNDestination_Selection_Based_On_DropDown", dataMap.get("Selection_Based_On"));
		cu.checkElementPresence("TopNDestination_ProductListButton");
		cu.checkElementPresence("TopNDestination_To_Date_SelectformCalendar");
		cu.checkElementPresence("TopNDestination_Display_Button");
		cu.checkElementPresence("TopNDestination_Cancel_Button");
		cu.checkElementPresence("TopNDestination_Export_Link");
		
	
		
		cu.getScreenShot("Validation Of UI elements in TopNDestination Screen");
		test = cu.getExTest();
