...
public class TC_02_SupplierCostMgmtSearch implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_02_SupplierCostMgmtSearch.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest(
				"Execution triggered for - TC_02_SupplierCostMgmtSearch -with TestdataId: " + uniqueDataId);
		...
		cu.checkMessage("application_PopUpTitle", "Clicking CANCEL button", "Warning: This action will reload the initial cost card. Do you want to Continue?");
