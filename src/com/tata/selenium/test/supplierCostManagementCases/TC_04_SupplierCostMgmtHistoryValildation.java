...
public class TC_04_SupplierCostMgmtHistoryValildation implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_04_SupplierCostMgmtHistoryValildation.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent
				.startTest("Execution triggered for - TC_04_SupplierCostMgmtHistoryValildation -with TestdataId: " + uniqueDataId);
		...
		//First validation: Cost Card Tab has 5 latest values or not.
		
		 List<String> retStrOPs=cu.getAllOptionsFromDropDown("CostManagement_Cost_CardLst");
		 ...
		 cu.checkFiveLatestValFromDropDownForCostMgmt("CostManagement_Cost_CardLst", retStrOPs);
