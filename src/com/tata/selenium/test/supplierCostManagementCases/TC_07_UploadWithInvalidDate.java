...
public class TC_07_UploadWithInvalidDate implements ApplicationConstants {
	
	private static final Logger LOGGER = Logger.getLogger(TC_07_UploadWithInvalidDate.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest(
				"Execution triggered for - TC_09_UploadWithInvalidCostValue -with TestdataId: " + uniqueDataId);
		...
		// Uploading the csv file with modified data
	...
	public void modifyCoverageUsingUploadOption(CommonUtils cu, Map<String, String> dataMap) throws Exception {
		...
		cu.checkMessage("application_PopUpMessage", "Check popup waring message after uploading the file",
				dataMap.get("CostManagement_Destination_FilterLst")
						+ " - Date format is wrong, expected format is (DD-MM-YYYY) - found in the row 1");
	}
