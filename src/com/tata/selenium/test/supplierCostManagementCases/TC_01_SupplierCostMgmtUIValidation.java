...
public class TC_01_SupplierCostMgmtUIValidation implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_01_SupplierCostMgmtUIValidation.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest(
				"Execution triggered for - TC_01_SupplierCostMgmtUIValidation -with TestdataId: " + uniqueDataId);
		...
		cu.checkEditableDropDown("CostManagement_ServiceLst", dataMap.get("CostManagement_ServiceLst"));
		cu.checkEditableDropDown("CostManagement_Supplier_Acc_NameLst",
				dataMap.get("CostManagement_Supplier_Acc_NameLst"));
		cu.checkEditableDropDown("CostManagement_Supplier_NameLst", dataMap.get("CostManagement_Supplier_NameLst"));
		cu.checkEditableDropDown("CostManagement_Cost_CardLst", dataMap.get("CostManagement_Cost_CardLst"));

		// Validating non editable text box
		cu.checkNonEditableBox("CostManagement_CurrencyTxt");

		// Validating all buttons
		cu.checkElementPresence("CostManagement_Upload");
		cu.checkElementPresence("CostManagement_DisplayBtn");
		cu.checkElementPresence("CostManagement_SubmitBtn");
		cu.checkElementPresence("CostManagement_CancelBtn");
