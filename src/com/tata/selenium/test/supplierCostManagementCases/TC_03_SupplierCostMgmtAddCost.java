...
public class TC_03_SupplierCostMgmtAddCost implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_03_SupplierCostMgmtAddCost.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent
				.startTest("Execution triggered for - TC_03_SupplierCostMgmtAddCost -with TestdataId: " + uniqueDataId);
		...
		// Passing cost value more than 0.23
		if ("MT SMS".equalsIgnoreCase(dataMap.get("CostManagement_ServiceLst"))) {
			cu.clickElement("CostManagement_EditCostTxt", "$dynamicVal$",
