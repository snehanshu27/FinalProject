...
public class TC_08_Search implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_08_Search.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest(
				"Execution triggered for - TC_08_Search -with TestdataId: " + uniqueDataId);
		...
		cu.selectCheckBox("dynamicCoverageChk", "$destination$", dataMap.get("DestinationFilterLst"));
		Thread.sleep(4000);
		cu.clickElement("Effective_DateTxt", "$destination$", dataMap.get("DestinationFilterLst"));
		cu.selectCalendarDate("Effective_DateTxt", dataMap.get("Effective_DateTxt"));
	
		cu.clickElement("SubmitBtn");
		cu.checkMessage("application_PopUpMessage", "Click submit", "The new price(s) have been successfully entered and will become active on the effective date. You will receive a confirmation email for reference.");
