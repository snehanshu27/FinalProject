...
public class TC_01_CustomerPriceMgmtUIValidation implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_01_CustomerPriceMgmtUIValidation.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest(
				"Execution triggered for - TC_01_CustomerPriceMgmtUIValidation -with TestdataId: " + uniqueDataId);
		...
		cu.checkEditableDropDown("ServiceNameLst", dataMap.get("ServiceNameLst"));
		cu.checkEditableDropDown("CustomerNameLst", dataMap.get("CustomerNameLst"));
		...
		cu.checkEditableDropDown("PriceHistoryLst", dataMap.get("PriceHistoryLst"));

		// Validating Readonly properties
		cu.checkReadonlyProperty("CurrencyTxt");
		cu.checkReadonlyProperty("RatePeriod");
		
		// Validating all buttons
		cu.checkElementPresence("UploadBtn");
		cu.checkElementPresence("DisplayBtn");
		cu.checkElementPresence("SubmitBtn");
