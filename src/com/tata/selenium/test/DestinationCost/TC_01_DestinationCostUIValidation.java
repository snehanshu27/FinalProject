...
public class TC_01_DestinationCostUIValidation implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_01_DestinationCostUIValidation.class.getName());
	...
	public void DO (String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest("Execution triggered for - "+TC_01_DestinationCostUIValidation.class.getName()+" - "+uniqueDataId);
		...
		cu.checkElementPresence("DestinationCost_CountryListButton");
		cu.checkElementPresence("DestinationCost_DestinationListButton");
		cu.checkElementPresence("DestinationCost_DisplayButton");
		cu.checkElementPresence("DestinationCost_CancelButton");
		cu.checkElementPresence("DestinationCost_ExportCSVLink");
		
		cu.getScreenShot("Validation Of UI elements in Destination Cost Screen");
		test = cu.getExTest();
