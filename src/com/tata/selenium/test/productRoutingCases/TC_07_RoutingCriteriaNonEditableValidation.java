...
public class TC_07_RoutingCriteriaNonEditableValidation implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_07_RoutingCriteriaNonEditableValidation.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest("Execution triggered for - TC_07_RoutingCriteriaNonEditableValidation -with TestdataId: " + uniqueDataId);
		...
		cu1.checkReadonlyProperty("Product_Routing_SupplierAccount_Priority_Textbox", "$CountryName$~$DestinationName$~$SupplierAccName$", dataMap.get("Product_CountryLst")+"~"+dataMap.get("Product_DestinationLst")+"~"+dataMap.get("SupplierAccName"));
