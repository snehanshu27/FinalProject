...
public class TC_01_RoutingUIValidation implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_01_RoutingUIValidation.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest(
				"Execution triggered for - TC_01_RoutingUIValidation -with TestdataId: " + uniqueDataId);
		...
		cu.checkEditableDropDown("Product_NameLst", dataMap.get("Product_NameLst"));
		cu.checkEditableDropDown("Product_CountryLst", dataMap.get("Product_CountryLst"));

		// Validating all buttons
		cu.checkElementPresence("Product_DetailsBtn");
		cu.checkElementPresence("Product_DisplayBtn");
		cu.checkElementPresence("Product_SubmitBtn");
		cu.checkElementPresence("Product_CancelBtn");
		cu.checkElementPresence("Product_ExportBtn");
