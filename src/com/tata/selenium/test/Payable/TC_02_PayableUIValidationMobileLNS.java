...
//import com.tata.selenium.test.ReceivablesCases.TC_02_ReceivablesUIValidationMobileLNS;
...
public class TC_02_PayableUIValidationMobileLNS implements ApplicationConstants {
	
	private static final Logger LOGGER = Logger.getLogger(TC_02_PayableUIValidationMobileLNS.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest(
				"Execution triggered for - TC_02_PayableUIValidationMobileLNS -with TestdataId: " + uniqueDataId);
		...
		cu.checkEditableDropDown("SupplierAccLst", dataMap.get("SupplierAccLst"));
		...
		cu.getScreenShot("Validation Of Payables Screen");
