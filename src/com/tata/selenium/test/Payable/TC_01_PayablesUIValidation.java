...
//import com.tata.selenium.test.ReceivablesCases.TC_01_ReceivablesUIValidation;
...
public class TC_01_PayablesUIValidation implements ApplicationConstants {

	private static final Logger LOGGER = Logger.getLogger(TC_01_PayablesUIValidation.class.getName());
	...
	public void DO(String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest(
				"Execution triggered for - TC_01_PayablesUIValidation -with TestdataId: " + uniqueDataId);
