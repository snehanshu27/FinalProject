...
public class TC_01_ContactManagementUIValidation implements ApplicationConstants {
	private static final Logger LOGGER = Logger.getLogger(TC_01_ContactManagementUIValidation.class.getName());
	...
	public void DO (String uniqueDataId, String testCaseId) throws Exception {
		...
		test = extent.startTest("Execution triggered for - "+TC_01_ContactManagementUIValidation.class.getName()+" - "+uniqueDataId);
		...
		cu.checkEditableDropDown("ContactManagement_CustomerNameLst", dataMap.get("CustomerNameLst"));
		cu.checkEditableDropDown("ContactManagement_CustomerAccountNameLst", dataMap.get("CustomerAccountNameLst"));
		cu.checkElementPresence("ContactManagement_LastUpdatedDateTxtBox");
		cu.checkElementPresence("ContactManagement_LastUpdatedUserTxtBox");
		cu.checkElementPresence("ContactManagement_DisplayButton");
		cu.checkElementPresence("ContactManagement_SubmitButton");
		cu.checkElementPresence("ContactManagement_CancelButton");
		cu.checkElementPresence("ContactManagement_AddContactButton");
		cu.checkElementPresence("ContactManagement_ExportCSVLink");
		
		cu.getScreenShot("Validation Of UI elements in Contact Management Screen");
		test = cu.getExTest();
